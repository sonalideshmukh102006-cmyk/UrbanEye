...
export const MOCK_TRAFFIC_CORRIDORS = [
  ...
  { id: 'TC-2A', name: 'FC Road (North)', density: 85, status: 'High Congestion', delay: '10 min', lastUpdatedMinutesAgo: 12, sourceBus: 'BUS-105', coordinates: [[73.8400, 18.5250], [73.8405, 18.5235], [73.8410, 18.5220]], vehicleStats: { heavy: 3, fourWheeler: 50, twoWheeler: 100 } },
