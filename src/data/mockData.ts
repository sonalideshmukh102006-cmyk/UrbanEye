...
export const MOCK_TRAFFIC_CORRIDORS = [
  ...
  { id: 'TC-1B', name: 'MG Road (South)', density: 45, status: 'Moderate', delay: '2 min', lastUpdatedMinutesAgo: 5, sourceBus: 'BUS-102', coordinates: [[73.8735, 18.5135], [73.8720, 18.5150], [73.8700, 18.5165], [73.8680, 18.5175], [73.8660, 18.5185], [73.8640, 18.5200]], vehicleStats: { heavy: 14, fourWheeler: 75, twoWheeler: 35} },
