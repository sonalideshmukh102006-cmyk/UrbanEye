...
export const MOCK_INCIDENTS = [
  ...
  {
    id: 'INC-016', type: 'MissingSign', description: 'Multilingual stop sign verification', locationName: 'ShivajiNagar', latitude: 18.5300, longitude: 73.8400, severity: 'Low',
  ...
  },
  {
    ...
    imageUrl: 'https://c8.alamy.com/comp/F15BFF/blurred-out-of-focus-lights-from-cars-traffic-lights-and-street-lights-F15BFF.jpg',
    croppedImageUrl: 'https://c8.alamy.com/comp/F15BFF/blurred-out-of-focus-lights-from-cars-traffic-lights-and-street-lights-F15BFF.jpg',
...
export const MOCK_TRAFFIC_CORRIDORS = [
  { id: 'TC-1A', name: 'MG Road (North)', density: 40, status: 'Moderate', delay: '2 min', lastUpdatedMinutesAgo: 5, sourceBus: 'BUS-102', coordinates: [[73.8767, 18.5104], [73.8760, 18.5115], [73.8750, 18.5125], [73.8735, 18.5135]], vehicleStats: { heavy: 10, fourWheeler: 50, twoWheeler: 20} },
  { id: 'TC-1B', name: 'MG Road (South)', density: 95, status: 'Gridlock', delay: '10 min', lastUpdatedMinutesAgo: 5, sourceBus: 'BUS-102', coordinates: [[73.8735, 18.5135], [73.8720, 18.5150], [73.8700, 18.5165], [73.8680, 18.5175], [73.8660, 18.5185], [73.8640, 18.5200]], vehicleStats: { heavy: 14, fourWheeler: 75, twoWheeler: 35} },
  { id: 'TC-2A', name: 'FC Road (North)', density: 85, status: 'High Congestion', delay: '10 min', lastUpdatedMinutesAgo: 35, sourceBus: 'BUS-105', coordinates: [[73.8400, 18.5250], [73.8405, 18.5235], [73.8410, 18.5220]], vehicleStats: { heavy: 3, fourWheeler: 50, twoWheeler: 100 } },
  { id: 'TC-2B', name: 'FC Road (South)', density: 30, status: 'Clear', delay: '0 min', lastUpdatedMinutesAgo: 12, sourceBus: 'BUS-105', coordinates: [[73.8410, 18.5220], [73.8415, 18.5200], [73.8425, 18.5175], [73.8430, 18.5160], [73.8440, 18.5140]], vehicleStats: { heavy: 2, fourWheeler: 35, twoWheeler: 90 } },
  { id: 'TC-3', name: 'JM Road', density: 30, status: 'Clear', delay: '0 min', lastUpdatedMinutesAgo: 45, sourceBus: 'BUS-108', coordinates: [[73.8500, 18.5300], [73.8510, 18.5270], [73.8520, 18.5250], [73.8530, 18.5230], [73.8540, 18.5215], [73.8550, 18.5200], [73.8555, 18.5170], [73.8560, 18.5150]], vehicleStats: { heavy: 2, fourWheeler: 40, twoWheeler: 80 } },
  { id: 'TC-4', name: 'Swargate Junction', density: 95, status: 'Gridlock', delay: '80 min ', lastUpdatedMinutesAgo: 2, sourceBus: 'BUS-201', coordinates: [[73.8585, 18.5010]], vehicleStats: { heavy: 25, fourWheeler: 105, twoWheeler: 45 }, bottleneckReason: 'Accident blocking two lanes and heavy water logging near the intersection.', proofImageUrl: '/public/Gemini_Generated_Image_o0afwlo0afwlo0af.png' },
  { id: 'TC-5', name: 'Koregaon Park Road', density: 75, status: 'High Congestion', delay: '10 min', lastUpdatedMinutesAgo: 35, sourceBus: 'BUS-112', coordinates: [[73.8950, 18.5350], [73.8965, 18.5340], [73.8980, 18.5330]], vehicleStats: { heavy: 12, fourWheeler: 160, twoWheeler: 120 } },
  { id: 'TC-6', name: 'Viman Nagar Highway', density: 45, status: 'Moderate', delay: '2 min', lastUpdatedMinutesAgo: 8, sourceBus: 'BUS-110', coordinates: [[73.9160, 18.5620], [73.9175, 18.5630], [73.9190, 18.5640]], vehicleStats: { heavy: 30, fourWheeler: 110, twoWheeler: 85 } },
  { id: 'TC-7', name: 'Pune Station Road', density: 88, status: 'High Congestion', delay: '15 min', lastUpdatedMinutesAgo: 50, sourceBus: 'BUS-103', coordinates: [[73.8730, 18.5280], [73.8720, 18.5290], [73.8710, 18.5300]], vehicleStats: { heavy: 28, fourWheeler: 175, twoWheeler: 220 }, bottleneckReason: 'Unexpected road construction work taking up left lane.', proofImageUrl:'/public/Gemini_Generated_Image_acwufiacwufiacwu.png'},
  { id: 'TC-8', name: 'Kothrud Stand Road', density: 55, status: 'Moderate', delay: '4 min', lastUpdatedMinutesAgo: 15, sourceBus: 'BUS-115', coordinates: [[73.8100, 18.5050], [73.8120, 18.5060], [73.8140, 18.5070]], vehicleStats: { heavy: 8, fourWheeler: 90, twoWheeler: 150 } },
];

export const MOCK_VIOLATIONS = [
  { id: 'V-102', type: 'Wrong Way', bus: 'ANPR-Unregistered', vehicleNo: 'MH 14 XY 9876', location: 'FC Road', longitude: 73.8420, latitude: 18.5220, time: '14:21', severity: 'Low', status: 'Verified', confidenceScore: 94.7, imageUrl: 'https://en.pimg.jp/114/682/637/1/114682637.jpg', croppedImageUrl: 'https://en.pimg.jp/114/682/637/1/114682637.jpg', anprImageUrl:'/public/9876.png'},
  { id: 'V-103', type: 'Hit and Run', bus: 'BUS-205', vehicleNo: 'MH 12 L 1934', location: 'MG Road Junction', longitude: 73.8760, latitude: 18.5130, time: '14:18', severity: 'Critical', status: 'Verified', confidenceScore: 89.5, imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCy17wMVt-D51lrfJYqgZU7Mru74IRh3ll6irlw9Z8YA&s', croppedImageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCy17wMVt-D51lrfJYqgZU7Mru74IRh3ll6irlw9Z8YA&s', anprImageUrl:'/public/1934.png'},
  { id: 'V-107', type: 'Hit and Run', bus: 'BUS-203', vehicleNo: 'MH 12 QK 8822', location: 'Pune Station', longitude: 73.8730, latitude: 18.5280, time: '14:12', severity: 'Critical', status: 'Unverified', confidenceScore: 91.2, imageUrl: 'https://ewscripps.brightspotcdn.com/dims4/default/f028308/2147483647/strip/true/crop/4032x3024+0+0/resize/1280x960!/quality/90/?url=http:%2F%2Fewscripps-brightspot.s3.amazonaws.com%2Ffc%2F94%2F9cea0b3f4a8c8881396fded90763%2F82d-st-hit-and-run.jpeg', croppedImageUrl: 'https://ewscripps.brightspotcdn.com/dims4/default/f028308/2147483647/strip/true/crop/4032x3024+0+0/resize/1280x960!/quality/90/?url=http:%2F%2Fewscripps-brightspot.s3.amazonaws.com%2Ffc%2F94%2F9cea0b3f4a8c8881396fded90763%2F82d-st-hit-and-run.jpeg', anprImageUrl:'/public/8822.png'},
